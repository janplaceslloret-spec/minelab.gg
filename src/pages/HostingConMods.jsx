...
const productJsonLd = { '@context': 'https://schema.org', '@type': 'Product', name: 'MineLab — Hosting Minecraft con mods', description: 'Hosting Minecraft modded con asistente IA: instala cualquier modpack (Forge, Fabric, NeoForge) en 2 minutos. ATM10, RLCraft, Vault Hunters, Pixelmon. Desde 7,99 €/mes.', image: 'https://minelab.gg/og/hosting-mods.png', brand: { '@type': 'Brand', name: 'MineLab' }, aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.9', reviewCount: '127', bestRating: '5' }, offers: { '@type': 'AggregateOffer', priceCurrency: 'EUR', lowPrice: '7.99', highPrice: '24.99', offerCount: 5, availability: 'https://schema.org/InStock', url: 'https://minelab.gg/hosting-minecraft-con-mods' } };
...
export default function HostingConMods() {
  ...
  useDocumentMeta({
    ...
    description: 'Hosting Minecraft modded con asistente IA: instala cualquier modpack en 2 minutos. ATM10, RLCraft, Vault Hunters, Pixelmon. Desde 7,99 €/mes.',
    ...
    <SeoLayout>
      ...
      <article className="container mx-auto px-6 max-w-6xl">
        ...
        <section className="py-20 border-t border-white/5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { ram: '4 GB', price: '7,99', use: 'Vanilla, Paper, mods ligeros, Pixelmon', n: '01' },
              { ram: '6 GB', price: '10,99', use: 'Forge medio, RLCraft, Stoneblock', n: '02' },
              { ram: '8 GB', price: '14,99', use: 'ATM10, Vault Hunters básico, Better MC', n: '03', highlight: true },
              { ram: '12 GB', price: '21,99', use: 'Modpacks XL, Vault Hunters 600+', n: '04' },
            ].map((p) => (
